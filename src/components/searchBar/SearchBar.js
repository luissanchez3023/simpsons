...
import simpsons_logo from '../../images/logosimpsons.svg';
  ...
  const handleClick = () => {
    ...
    return (
      <div className='search_page'>
        ...
        <main>
          <h1 className='title'>Descubre citas aqui</h1>
          <section className='search–section'>
            ...
            <aside>
            <button className='gray-button' onClick={handleClick}>Show me more</button>
            </aside>
        </main>
      </div>
    );
